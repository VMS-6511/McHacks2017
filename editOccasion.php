		...
		<div class="col-md-6">
			<div class="row" style="padding-top:50px">
				<form method=post action="">
					...
					<input type="text" class="form-control" id="Occasion Name" name="" placeholder="Event Name">
					</div>
					<div class="form-group">
					<input type="text" class="form-control" id="startDate" name="" placeholder="Start Date (yyyy/dd/mm)">
					</div>
					<div class="form-group">
					<input type="text" class="form-control" id="endDate" name="" placeholder="End Date (yyyy/dd/mm)">
					</div>
					<div class="form-group">
